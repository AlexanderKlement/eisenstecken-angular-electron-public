...
export class ArticleSupplierComponent implements OnInit {
    ...
    private initArticleSupplierTable() {
        this.articleTableSource = new TableDataSource(
            ...
            (api, filter, sortDirection, skip, limit) =>
                api.readArticlesBySupplierArticleSupplierSupplierIdGet(this.supplierId, skip, limit, filter),
            this.parseFunction,
            this.columns,
            (api) => api.readArticleCountBySupplierArticleSupplierCountSupplierIdGet(this.supplierId)
        );
    ...
    private initArticleStockTable() {
        this.articleTableSource = new TableDataSource(
            this.api,
            (api, filter, sortDirection, skip, limit) =>
                api.readArticlesByStockArticleStockStockIdGet(this.supplierId, skip, limit, filter),
            this.parseFunction,
            this.columns,
            (api) => api.readArticleCountBySupplierArticleSupplierCountSupplierIdGet(this.supplierId)
        );
