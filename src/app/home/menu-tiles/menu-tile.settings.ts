...
export const availableMenuTiles: MenuTileDetail[] = [
  {
    ...
    icon: 'group',
    link: '/client',
    requiredRights: ['clients:all'],
  },
  {
    title: 'Aufträge',
    icon: 'domain',
    link: '/job',
    requiredRights: ['jobs:all'],
  },
  {
    title: 'Nachkalkulation',
    icon: 'calculate',
    link: '/recalculation',
    requiredRights: ['recalculations:all'],
  },
  {
    title: 'Bestellungen',
    icon: 'local_grocery_store',
    link: '/order',
    requiredRights: ['orders:all'],
  },
  {
    title: 'Lieferanten',
    icon: 'local_shipping',
    link: '/supplier',
    requiredRights: ['suppliers:all', 'stocks:all'],
  },
  {
    title: 'Lieferscheine',
    icon: 'assignment',
    link: '/delivery_note',
    requiredRights: ['delivery_notes:all'],
  },
  {
    title: 'Rechnungen',
    icon: 'money',
  ...
  },
  {
    ...
    icon: 'work',
    link: '/employee',
    requiredRights: ['hours:modify'],
  },
  {
    title: 'Benutzer',
    icon: 'person',
    link: '/user',
    requiredRights: ['users:all'],
  },
  {
    title: 'Arbeitstag',
    icon: 'schedule',
    link: '/work_day',
    requiredRights: ['nobody:hours:insert'],
  },
  {
    title: 'Stunden',
    icon: 'watch_later',
    link: '/mobile/hours',
    requiredRights: ['hours:insert'],
  },
  {
    title: 'Einstellungen',
    icon: 'settings',
    link: '/settings',
    requiredRights: ['parameters:set'],
  },
  {
    title: 'Kontakte',
    icon: 'phone',
