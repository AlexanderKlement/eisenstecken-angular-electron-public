...
export class InfoSettingsComponent implements OnInit {
  ...
  initCredentials(): void {
    ...
    this.api
      .readCredentialsCredentialGet(0, 1000)
      .pipe(first())
  ...
  onSubmitCredentials() {
    ...
    this.api
      .bulkUpdateCredentialsCredentialBulkPut(credentialUpdates)
      .pipe(first())
      .subscribe({
  ...
  onSubmitPrices() {
    ...
    this.api
      .bulkUpdatePricesPriceBulkPut(priceUpdates)
      .pipe(first())
      .subscribe({
  ...
  initTechnicalData(): void {
    ...
    this.api
      .readTechnicalDatasTechnicalDataGet(0, 1000)
      .pipe(first())
      .subscribe(technicalData => {
  ...
  addTechnicalDataArrayToFormGroup(technicalData: TechnicalData[]): void {
    for (const singleTechnicalData of technicalData) {
      this.getTechnicalDataFormArray().push(
        this.createTechnicalData(singleTechnicalData)
      );
    }
  }
  ...
  onSubmitTechnicalData() {
    ...
    this.api
      .bulkUpdateTechnicalDataTechnicalDataBulkPut(technicalDataUpdates)
      .pipe(first())
      .subscribe({
