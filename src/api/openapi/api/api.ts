...
export const APIS = [ArticleService, AuthService, ClientService, DefaultService, HealthService, JobService, OfferV2Service, OrderService, OrderBundleService, OrderedArticleService, RecalculationService, SchedulerService, TikTakService, TimeEntryService, VietService];
