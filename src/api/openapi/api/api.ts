...
export const APIS = [ArticleService, DefaultService, HealthService, OrderService, OrderBundleService, OrderedArticleService, RecalculationService, SchedulerService, TikTakService, VietService];
