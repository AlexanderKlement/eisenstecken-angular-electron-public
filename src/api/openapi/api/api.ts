...
export const APIS = [ArticleService, AuthService, ClientService, DefaultService, HealthService, JobService, OrderService, OrderBundleService, OrderedArticleService, RecalculationService, SchedulerService, TikTakService, TimeEntryService, VietService];
