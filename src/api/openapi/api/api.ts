...
export const APIS = [ArticleService, DefaultService, HealthService, OrderService, OrderBundleService, RecalculationService, SchedulerService, TikTakService, VietService];
